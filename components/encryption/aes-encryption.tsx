...
export default function AesEncryption() {
  ...
  const handleEncrypt = () => {
    ...
    try {
      ...
      switch (mode) {
        case "CBC":
          encrypted = CryptoJS.AES.encrypt(text, keyUtf8, { iv, mode: CryptoJS.mode.CBC }).toString()
          break
        case "ECB":
          encrypted = CryptoJS.AES.encrypt(text, keyUtf8, { mode: CryptoJS.mode.ECB }).toString()
          break
        case "CFB":
          encrypted = CryptoJS.AES.encrypt(text, keyUtf8, { iv, mode: CryptoJS.mode.CFB }).toString()
          break
        case "OFB":
          encrypted = CryptoJS.AES.encrypt(text, keyUtf8, { iv, mode: CryptoJS.mode.OFB }).toString()
          break
        case "CTR":
          encrypted = CryptoJS.AES.encrypt(text, keyUtf8, { iv, mode: CryptoJS.mode.CTR }).toString()
          break
        default:
  ...
  const handleDecrypt = () => {
    ...
    try {
      ...
      switch (mode) {
        case "CBC":
          decrypted = CryptoJS.AES.decrypt(text, keyUtf8, { iv, mode: CryptoJS.mode.CBC }).toString(CryptoJS.enc.Utf8)
          break
        case "ECB":
          decrypted = CryptoJS.AES.decrypt(text, keyUtf8, { mode: CryptoJS.mode.ECB }).toString(CryptoJS.enc.Utf8)
          break
        case "CFB":
          decrypted = CryptoJS.AES.decrypt(text, keyUtf8, { iv, mode: CryptoJS.mode.CFB }).toString(CryptoJS.enc.Utf8)
          break
        case "OFB":
          decrypted = CryptoJS.AES.decrypt(text, keyUtf8, { iv, mode: CryptoJS.mode.OFB }).toString(CryptoJS.enc.Utf8)
          break
        case "CTR":
          decrypted = CryptoJS.AES.decrypt(text, keyUtf8, { iv, mode: CryptoJS.mode.CTR }).toString(CryptoJS.enc.Utf8)
          break
        default:
